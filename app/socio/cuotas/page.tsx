...
export default function MisCuotasPage() {
        ...
        if (userData) {
          ...
          if (user.idPersona) {
            try {
              ...
              console.error("Error recargando cuotas:", err);
            }
          }
        }
      } else {
  ...
  const calcularTotales = () => {
    ...
    const deudaTotal = cuotasFiltradas
      .filter((c) => c.Estado === 0)
      .reduce((sum, c) => sum + (c.Monto + (c.Recargo || 0)), 0);
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Consulta tu historial de cuotas y realiza pagos online
          </p>
        </div>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Filtra tus cuotas por año y estado
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Estadísticas de tus cuotas para el año {filtroAño}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center p-4 bg-red-50 rounded-lg">
                <div className="text-2xl font-bold text-red-600">
                  {formatCurrency(totales.deudaTotal)}
                </div>
        ...
        <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Completa el pago de tu cuota de forma segura
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Los pagos en efectivo solo pueden realizarse en la
